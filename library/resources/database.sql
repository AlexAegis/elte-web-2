...
insert into user (username, password, name) value ('admin@admin.com', '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918', 'admin');
...
insert into book (owner, author, title, category)
  value ('admin@admin.com', 'jesus', 'bible', (select id from bookcategory where name = 'fantasy'));
insert into book (owner, author, title, category)
  value ('admin@admin.com', 'J. R. R. Tolkien', 'Lord of the rings', (select id from bookcategory where name = 'fantasy'));
